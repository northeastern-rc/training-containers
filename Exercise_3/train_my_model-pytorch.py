...
## For this tutorial, we will use the CIFAR10 dataset. This script demonstrates Training an image classifier.
import torch
import torchvision
...
## Download and extract data into the ./data folder
...
net = Net()
#methods will recursively go over all modules and convert their parameters and buffers to CUDA tensors:
net.to(device)
